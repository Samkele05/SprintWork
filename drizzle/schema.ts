...
export const jobSeekerProfiles = mysqlTable(
  "jobSeekerProfiles",
  {
    ...
    salaryExpectation: decimal("salaryExpectation", {
      precision: 10,
      scale: 2,
    }),
...
export const jobs = mysqlTable(
  ...
  table => ({
    sourceJobIdIdx: unique("job_sourceJobId_idx").on(
      table.sourceJobId,
      table.source
    ),
...
export const savedSearches = mysqlTable(
  "savedSearches",
  {
    ...
    alertFrequency: mysqlEnum("alertFrequency", [
      "daily",
      "weekly",
      "immediate",
    ]).default("daily"),
...
export const connections = mysqlTable(
  "connections",
  {
    ...
    status: mysqlEnum("status", ["pending", "accepted", "blocked"]).default(
      "pending"
    ),
